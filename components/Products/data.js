...
import productClass from '../../styles/Products.module.css'; 
...
export const products = [
    {
        ...
        image: printerImage,
        class: productClass.headerTextClass1
    },
    {
        ...
        image: hospitalImage,
        class: productClass.prodClass
    },
    {
        header: "Enterprise Resource Planning Solution",
        text: `At Citrine we apply our operational services across to every solution – even our ERP solutions, 
        Our solutions are agile, scalable and designed to accommodate your changing business requirements.
        However, systems of the future must provide smarter means of delivering meaningful information to a diverse set of stakeholders who operate in a digital healthcare environment.`,
        image: erpImage,
        class: productClass.prodClass
    },
    {
        header: "Document Management Solution",
        text: `  At Citrine Technologies, we provide a solution that provides quick and easy data retrieval for large and small environments alike. 
        Allowing document collaboration and improving team efficiency while eliminating high costs of document management.`,
        image: documnentImage,
        class: productClass.headerTextClass2
    },
