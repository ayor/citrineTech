            ...
            <div className="container" id="services">
                <div className="row m-2  ">
                    ...
                    <div className="col-12 col-md-6 col-lg-8 pt-3 px-3">
                        <p className="text-secondary ">We are one of the fastest growing solutions providers, a feat that has been fueled by the results we have achieved working with clients in a wide array of niches.</p>
